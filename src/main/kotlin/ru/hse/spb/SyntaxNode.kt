...
sealed class Statement : SyntaxNode()
sealed class Expression : Statement()

data class Block(val statements: List<Statement> = emptyList()) : Statement()
...
data class If(val condition: Expression, val ifBody: Block, val elseBody: Block? = null) : Statement()
data class Assignment(val name: String, val value: Expression) : Statement()
data class Return(val value: Expression) : Statement()

data class FunctionCall(val name: String, val args: List<Expression> = emptyList()) : Expression()
